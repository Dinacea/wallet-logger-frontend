    ...
    concat: {
      ...
      dist: {
        src: [
          ...
          '../js/wallet-logger-frontend/users/users.module.js',
          '../js/wallet-logger-frontend/users/users.controller.js',
          '../js/wallet-logger-frontend/users/users-login-screen.component.js',
          '../js/wallet-logger-frontend/users/users-logout-screen.component.js',
